...
from PyQt6.QtCore import pyqtSignal, QThread, QTimer, Qt, QByteArray
...
class SettingsTab(QWidget):
    def __init__(self, worker: EngineWorker):
        ...
        self.backend_url = QLineEdit(getattr(cfg, "backend_url", "https://mteas-backend.onrender.com"))
        self.backend_url.setPlaceholderText("https://mteas-backend.onrender.com")
    ...
    def _load_profile(self, name):
        ...
        self.backend_url.setText(getattr(cfg, "backend_url", "https://mteas-backend.onrender.com"))
    ...
    def _save(self):
        ...
        cfg.backend_url = self.backend_url.text().strip() or "https://mteas-backend.onrender.com"
...
_ICON_SVG = b"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  <defs>
  ...
  <path d="M16 2 L28 6.5 L28 17.5 C28 24 22.5 29 16 31 C9.5 29 4 24 4 17.5 L4 6.5 Z" fill="url(#bg)"/>
  <rect x="8.5"  y="14.5" width="3" height="5.5" rx="1.5" fill="white" opacity="0.75"/>
  <rect x="13"   y="11"   width="3" height="12"   rx="1.5" fill="white"/>
  <rect x="17.5" y="13"   width="3" height="8.5"  rx="1.5" fill="white" opacity="0.85"/>
  <rect x="22"   y="15.5" width="3" height="4"    rx="1.5" fill="white" opacity="0.60"/>
</svg>"""
